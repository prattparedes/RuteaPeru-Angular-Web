    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, product_model_1.ProductModel.create(data_1.sample_products)];
            case 2:
                _a.sent();
...
router.get('/search/:searchTerm', (0, express_async_handler_1["default"])(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                searchRegEx = RegExp(req.params.searchTerm, 'i');
                return [4 /*yield*/, product_model_1.ProductModel.find({ name: { $regex: searchRegEx } })];
            case 1:
                products = _a.sent();
                res.send(products);
                return [2 /*return*/];
...
router.get('/tag/:tagName', (0, express_async_handler_1["default"])(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, product_model_1.ProductModel.find({ tags: req.params.tagName })];
            case 1:
                products = _a.sent();
                res.send(products);
                return [2 /*return*/];
...
router.get('/:productId', (0, express_async_handler_1["default"])(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, product_model_1.ProductModel.findById(req.params.productId)];
            case 1:
                product = _a.sent();
                res.send(product);
                return [2 /*return*/];
